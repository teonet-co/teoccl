...
{
    curl -vvf -X PUT -H "Content-Type: application/json" -d '{"list_in_downloads":true}' -u$CI_BINTRAY_USER:$CI_BINTRAY_API_KEY  "https://api.bintray.com/file_metadata/teonet-co/u/"$PACKET_NAME"/"$VER"/"$PACKAGE_NAME"_"$1".deb"
}
